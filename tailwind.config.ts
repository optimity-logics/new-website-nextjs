  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'card-1': "url('/images/homePagev2/card-1.png')",
        'card-2': "url('/images/homePagev2/card-2.png')",
        'card-3': "url('/images/homePagev2/card-3.png')",
        'tech-we-work': "url('/images/homePagev2/tech-we-work.png')",
