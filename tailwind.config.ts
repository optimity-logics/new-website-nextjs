  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        bgHealthCare: "url('/webp/solution/Healthcare.webp')",
        bgFinance: "url('/webp/solution/Finance.webp')",
        bgRealEstate: "url('/webp/solution/RealEstate.webp')",
        bgRetail: "url('/webp/solution/Retail.webp')",
        bgEducation: "url('/webp/solution/Education.webp')",
        bgLogistics: "url('/webp/solution/Logistics.webp')",
        bgStartup: "url('/webp/solution/StartupSolutions.webp')",
        bgEnterPriseSol: "url('/webp/solution/EnterpriseSolutions.webp')",
        bgDevOps: "url('/webp/solution/DevOps.webp')",
        bgCloudSol: "url('/webp/solution/CloudSolution.webp')",
