...
const OurExpertise = () => {
  return (
    <Container className="!px-0">
      <div className="mb-10 ml-4 flex flex-col items-center gap-[30px] overflow-x-hidden sm:ml-6 md:mb-12 md:ml-8 lg:flex-row xl:mb-16 xl:ml-10 2xl:ml-20 3xl:mb-[140px] 3xl:ml-[100px]">
        <div className="flex w-full flex-col gap-5 lg:max-w-[375px] lg:gap-[100px]">
          <div className="flex flex-col gap-5 lg:gap-[25px]">
            <h3 className="font-Inter text-[45px] font-semibold leading-[50px] text-charcoalBlue 3xl:text-[60px] 3xl:leading-[65px]">
              Our <span className="text-red lg:block">Expertise</span>
            </h3>
            <p className="font-Inter text-lg font-normal leading-[26px] text-[#888790]">
            ...
            {ourExpertiseData &&
              ourExpertiseData.map((item) => (
                <SwiperSlide key={item.id}>
                  ...
                  >
                    <div
                      className="flex h-16 w-16 items-center justify-center rounded-full 3xl:h-[100px] 3xl:w-[100px]"
                    ...
                    <div className="flex flex-col gap-[50px]">
                      <div className="flex flex-col gap-5">
                        ...
                        <p className="font-Inter text-lg font-normal leading-[21.78px] text-[#888790]">
