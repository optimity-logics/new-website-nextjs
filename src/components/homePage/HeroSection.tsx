...
const HeroSection = () => {
  return (
    <div className="mb-4 h-full sm:mb-[100px]">
      <Container className="h-full w-full bg-homepagebg bg-cover bg-no-repeat px-4 pb-[50px] sm:px-6 sm:pb-5 md:px-8 lg:px-10">
        <div className="mx-auto flex max-w-[1251px] flex-col items-center gap-5 py-8 sm:py-11 md:gap-[26px] xl:pt-16 3xl:h-[calc(100vh-260px)] 3xl:gap-[30px] 3xl:pt-[100px] 4xl:pt-[147px]">
          <Button
          ...
          <div className="flex flex-col items-center gap-3 sm:gap-4 3xl:gap-[25px]">
            <h1 className="4xl:[50px] text-center font-Inter text-[35px] font-bold leading-[40px] tracking-[-0.16px] text-darkBlack sm:text-[42px] sm:leading-[48px] 3xl:text-[50px] 3xl:leading-[55px] 5xl:text-[60px] 5xl:leading-[65px]">
              Bring Your <span className="text-gradient">App Vision</span> to
              Life,
              <br /> Anytime with <span className="text-gradient">AI.</span>
            </h1>
            <p className="max-w-[927px] text-center font-Inter text-xl font-normal leading-6 text-charcoalBlue 4xl:text-[22px] 4xl:leading-[26px]">
