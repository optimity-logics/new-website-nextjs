...
const Faqs = () => {
  ...
  return (
    <NextUIProvider>
      <Container className="mb-10 md:mb-12 xl:mb-16 3xl:mb-[176px] 3xl:px-[200px]">
        <div className="flex flex-col gap-5 lg:gap-6 3xl:gap-[60px]">
          <SectionHeading
              ...
              faqsData.map((item, index) => {
                ...
                return (
                  <AccordionItem
                    ...
                    title={
                      <div
                        className={`flex items-center gap-5 lg:gap-[45px] ${isExpanded ? 'py-0' : '2xl:py-1 3xl:py-5'}`}
                      >
                        <span className="font-Inter text-2xl font-extrabold leading-7 text-black 3xl:text-[37.71px] 3xl:leading-[47.71px]">
                    ...
                    className="!rounded-none border-b !border-b-[#1110221a] !shadow-none"
