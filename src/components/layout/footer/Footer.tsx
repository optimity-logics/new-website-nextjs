          ...
          {/* <div className="flex flex-col justify-between gap-7 md:flex-row lg:items-center 3xl:gap-14">
            <div className="flex w-full max-w-[795px] flex-col gap-[35px]">
              ...
              <div className="flex flex-col gap-6 sm:gap-[30px]">
                <h3 className="font-opt text-[26px] font-semibold leading-[30px] text-white 5xl:text-4xl 5xl:leading-[38px]">
                  <span className="highlitedtextfooter block">
                    Have a question?
                  </span>
                  Our team is happy to assist you
                </h3>
                <span className="max-w-[666px] font-opt text-base font-light leading-[1.6rem] text-white 5xl:text-lg 5xl:leading-7">
                ...
                <div className="flex flex-col gap-[15px]">
                  <div className="flex items-start gap-2 sm:gap-[15px]">
                    ...
                    <span className="font-opt text-base font-light leading-[1.6rem] text-white md:pr-[26px] 5xl:text-lg 5xl:leading-7">
          ...
          <div className="grid w-full grid-cols-1 gap-10 sm:grid-cols-2 md:gap-x-4 md:gap-y-10 lg:grid-cols-4 xl:gap-[70px] 3xl:gap-20 4xl:gap-[95.14px]">
            {footerData?.footerLinks.map((section, index) => (
              <div key={index} className="flex flex-col gap-[21.37px]">
                <h3 className="tracking-[1.5 px] font-opt text-2xl font-normal text-white">
                  {section?.heading}
                </h3>
                <ul className="flex flex-col gap-3">
                  {section.items.map((item, idx) => (
                    <li
                      key={idx}
                      className="cursor-pointer font-opt text-lg font-light text-subtle transition-all duration-300 hover:text-lightBlue xl:w-max xl:text-nowrap"
                    >
