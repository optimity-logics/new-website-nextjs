              ...
              {showMegaMenu && (
                ...
                >
                  <div className="scale-up-ver-top flex w-[750px] flex-col gap-8 rounded-b-xl border-t-4 border-lightBlue bg-white p-5 shadow-lg lg:w-[1000px] xl:w-[1200px] 4xl:w-[1449px]">
                    <div className="flex flex-col justify-between gap-5 4xl:flex-row">
                    ...
                    {/* <div className="flex w-full max-w-[300px] flex-col gap-4 rounded-2xl border border-[#e4e4e4] bg-[#fafbfd] p-6 4xl:p-[35px]">
                        <h3 className="font-Poppins text-sm leading-5 text-[#212529] 4xl:font-semibold">
