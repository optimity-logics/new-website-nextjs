...
import devopsImg from '../../../../../public/webp/solution/devopps-solution.webp';
import cc from '../../../../../public/webp/solution/cloud-solution.webp';
import productPrototypeImg from '../../../../../public/webp/solution/product-prototype-solution.webp';
import onDemand from '../../../../../public/webp/solution/on-demand-business-solution.webp';

export const devOps: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'End-to-End DevOps Solutions',
    description: `Optimity Logics is a leading DevOps solutions company, serving as a hub of skilled DevOps engineers, transforming the software development lifecycle to quickly release software products without compromising on performance and security. Leave all your software development worries on us by subscribing to our managed DevOps services.`,
    techImg: devopsImg,
...
export const cloudComputing: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'End-to-End Cloud Computing Solutions',
    description: `Optimity Logics as a leading cloud computing services provider company with expertise in SaaS, PaaS, and IaaS, is helping organizations harness the potential of cloud and maximize business value. Be it smooth cloud migration, secure cloud-native solutions, or future-proof scalable solutions, our cloud experts deliver all with precision.`,
    techImg: cc,
    btnName: `let's connect`,
    btnLink: '',
    workWithTechnology: [
...
export const productPrototype: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Top Product Prototype Development Company',
    description: `Turn your idea of creating a product into reality with our experts who have successfully implemented prototypes of digital products through our product prototype development services. From initial ideation to implementing core business logic and launching in the market, we work with you every step of the way toward the greater success of your product`,
    techImg: productPrototypeImg,
    btnName: `let's connect`,
    btnLink: '',
    workWithTechnology: [
      {
...
export const onDemandApp: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Top On-Demand App Development Company',
    description: `We are a leading on-demand app development company with exceptional expertise in industry-specific, feature-rich on-demand web and mobile app development. Whether you're a startup or an enterprise, our on-demand app solutions are designed to scale effortlessly and ensure better business growth.`,
    techImg: onDemand,
    btnName: `let's connect`,
    btnLink: '',
    workWithTechnology: [
