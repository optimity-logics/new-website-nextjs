...
import startUp from '../../../../../public/webp/solution/startup-solution.webp';
import enterpriseSolutionImg from '../../../../../public/webp/solution/enterprise-solution.webp';

export const startUpSolution: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'App Development for Startups',
    description: `Leveraging our exceptional proficiency in app development for startups, we empower new-age startups to begin their digital journey through market-validated app development solutions. Irrespective of the idea’s intricacy, our experts build your app with stunning features while addressing all challenges efficiently.`,
...
export const enterpriseSolution: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Enterprise Software Development Company',
    description: `Redefine the way your business operates with our comprehensive end-to-end enterprise mobility solutions. As a leading enterprise software development company, our team of expert software engineers is dedicated to delivering highly customized solutions, ensuring your business's success.`,

    techImg: enterpriseSolutionImg,
    btnName: `let's connect`,
    btnLink: '',
    workWithTechnology: [
      {
