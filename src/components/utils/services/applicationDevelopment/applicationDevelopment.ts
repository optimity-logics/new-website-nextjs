...
import webApps from '../../../../../public/webp/services/web-design-development.webp';
import mobileAppDevelopmentImg from '../../../../../public/webp/services/mobile-development.webp';
import softwareDevelopmentImg from '../../../../../public/webp/services/software-development.webp';
import saasDevelopmentImg from '../../../../../public/webp/services/saas-app-development.webp';
import mvpDevelopmentImg from '../../../../../public/webp/services/mvp-development.webp';
import appModernizationImg from '../../../../../public/webp/services/app-modernization.webp';
import gameDevelopmentImg from '../../../../../public/webp/services/app-modernization.webp';

export const webAppDevelopment: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Web Development Company',
    description: `We provide end-to-end web development services for your digital transformation journey by utilizing our expertise in web technology to deploy scalable and industry-leading web applications tailored to support your business’s dynamic requirements and its path toward digital innovation. `,
    techImg: webApps,
    ...
    workWithTechnology: [
      ...
      {
        title: '6+',
        description: 'Years of Devs Avg. Experience',
      },
      {
        title: '90%',
...
export const saasDevelopment: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Top SaaS Development Company',
    description: `Whether its custom SaaS product development from scratch or enhancing an existing successful SaaS platform with additional functionality or a complete redesign, we have the best team for SaaS app development. Our team has successfully delivered over 50 SaaS-based solutions across various industries such as healthcare, finance, real estate, and more.`,
...
export const mvpDevelopment: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Top MVP Development Company',
    description: `Whether you're a visionary startup or an established enterprise, quickly market your product with a confident concept. Our fast-paced Minimum Viable Product (MVP) Development services ensure you go from product discovery to essential feature finalization swiftly. We offer custom MVP development solutions to meet your unique business demands, turning your vision into a competitive edge.`,
...
export const appModernization: IPropsDataTypes = {
  HeroSectionData: {
    ...
    description: `Take charge of your future by staying relevant in today’s tech landscape through our legacy application modernization services. Businesses partnering with MindInventory achieve optimal results with a strategic approach while upgrading applications seamlessly, without disrupting ongoing operations. Our application modernization solutions enhance app usability, features, functionality, performance, security, and scalability.`,
...
export const gameDevelopment: IPropsDataTypes = {
  HeroSectionData: {
    ...
    description: `MindInventory, as a top-notch game development company, is dedicated to bringing your unique gaming ideas to life with our cutting-edge mobile game development services. Our designated team of 2D/3D artists and expert Unreal Engine and Unity Game developers craft high-end games that captivate audiences and ensure lasting player retention.`,
