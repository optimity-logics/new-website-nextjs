...
import resource from '../../../../../public/svg/technology/mobile/resource.svg';
import presentationProductMan from '../../../../../public/webp/technology/mobile/present-product-man.webp';
import flutterLogo from '../../../../../public/svg/technology/mobile/flutter.svg';
import fireBase from '../../../../../public/svg/technology/mobile/firebase.svg';
...
export const hireReactDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    ...
    description: `Hire React developers with a track record of delivering 300+ successful projects for global clients since 2011. Our certified React JS developers for hire specialize in building exceptional front-end applications. Skip the hassle - Find best ReactJS developers with just a click!`,
    btnName: `schedule a call `,
    btnLink: '',
    workWithTechnology: [
      {
        title: '30+',
        description: 'ReactJS Developers',
      },
      {
        title: '90%',
...
export const hireNextDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire Next.js Developers',
    description: `Hire Next.js developers from MindInventory to bring unparalleled expertise while ensuring the scalability and efficiency of your projects. Our experts specialize in crafting server-side applications that seamlessly integrate with Next.js by leveraging architectural patterns and libraries, like Flux, Redux, and version control tools, providing innovative Next.js solutions.`,
    btnName: `schedule a call `,
    btnLink: '',
    workWithTechnology: [
      {
        title: '20+',
        description: 'NextJS Developers',
      },
      {
        title: '90%',
        description: `Developer's Retention Rate`,
...
export const hireAngularDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire AngularJS Developers',
    description: `Hire Angular developers from us, who have delivered over 80 successful projects for global clients since 2011. Our certified AngularJS programmers specialize in building a wide range of web apps, from single-page applications to large-scale enterprise apps. Hire your ideal Angular developer in just a click!`,
    btnName: `schedule a call `,
    btnLink: '',
    workWithTechnology: [
      {
        title: '15+',
        description: 'Angular Developers',
      },
      {
        title: '90%',
        description: `Developer's Retention Rate`,
...
export const hireVueDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire Vue JS Developers',
    description: `Hire Vue JS developers with a knack for developing exceptional UIs and web applications. Our Vue JS developers for hire offer end-to-end Vue JS development services, specializing in building interactive UIs, robust single-page applications (SPAs), and more such web solutions.`,
    btnName: `schedule a call `,
    btnLink: '',
    workWithTechnology: [
      {
...
export const hireTailwindCssDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire Tailwind CSS Developers',
    description: `Hire our top Tailwind CSS developers with a track record of delivering over 50 successful projects for global clients since 2011. Our certified Tailwind developers specialize in building modern and responsive web designs rapidly. Skip the hassle - find Tailwind custom CSS developers for hire with just a click!`,
    btnName: `schedule a call `,
    btnLink: '',
    workWithTechnology: [
      {
        title: '15+',
        description: 'Tailwind CSS Developers',
      },
      {
        title: '90%',
        description: `Developer's Retention Rate`,
...
export const hireJavascriptDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire JavaScript Developers',
    description: `Hire full stack developers from our team who have successfully delivered 200+ projects to global clients. Since 2011, we have been delivering certified full-stack developers with proper screening and proven experience in working on projects like yours. You're just a click away from hiring your best-fit full stack programmer!`,
    btnName: `schedule a call `,
    btnLink: '',
    workWithTechnology: [
      {
      ...
      {
        title: '3+',
        description: `Years of Dev. Avg. Experiences`,
      },
      {
        title: '40+',
        description: 'Countries We Served',
...
export const hireBackboneJs: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire Backbone.Js Developers',
    description: `Optimity Logics is a preferred destination for global businesses to hire Webflow developers to reap benefits of professional expertise, top-notch design quality, and tailored solutions while ensuring seamless communication and collaboration. Whether you need to build a new website, enhance an existing one, or develop an e-commerce platform, our skilled Webflow developers are ready to deliver effective results that align with your goals.`,
    btnName: `schedule a call `,
    btnLink: '',
    workWithTechnology: [
      {
        title: '150+',
        description: 'Backbone Developers',
      },
      {
        title: '3+',
        description: `Years of Dev. Avg. Experiences`,
...
export const hireWebflowDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    ...
    workWithTechnology: [
      {
        title: '150+',
        description: 'Webflow Developers',
      },
      {
        title: '3+',
        description: `Years of Dev. Avg. Experiences`,
