...
export const hireAIDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire AI Developers',
    description: `Hire AI developers from our team with extensive knowledge and hands-on experience in working with GANs, Neural Networks, LLMs and various AI concepts. Utilizing all, our AI engineers build intelligent AI solutions that revolutionize the way businesses work. Skip the hassle - Hire your ideal AI developer in just a click!`,
...
export const hireMLDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire ML Developers',
    description: `Whether you need predictive analytics, process automation, or deep learning solutions, hire machine learning engineer from our team, with extensive knowledge and hands-on experience in working with the latest ML Algorithms, catering to your unique requirements. Our ML engineers build intelligent solutions that revolutionize the way businesses operate. Hire ML engineers in just a click!`,
    btnName: `schedule a call `,
    btnLink: '',
    workWithTechnology: [
      {
