...
export const hireFlutterDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire Flutter Developers',
    description: `Hire Flutter developers from our team who have successfully delivered 300+ projects to global clients. Since 2011, our certified Flutter experts have been delivering robust app solutions. Skip the hassle - Hire your ideal Flutter app developer in just a click!`,
...
export const hireIosDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire iOS App Developers',
    description: `Hire iOS app developers from MindInventory, boasting a track record of 500+ successful projects for global clients since 2011. Our certified iOS developers for hire are adept at delivering innovative app solutions. Skip the hassle - hire iOS developers with just a click!`,
    btnName: `schedule a call `,
    btnLink: '',
    workWithTechnology: [
      {
...
export const hireAndroidDeveloper: IPropsDataTypes = {
  HeroSectionData: {
...
export const hireReactNativeDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire React Native App Developers',
    description: `Hire React Native app developers from our team who have successfully delivered 300+ projects to global clients. Since 2011, our certified React Native experts have been delivering robust app solutions. Skip the hassle - Hire React Native developer in just a click!`,
    btnName: `schedule a call `,
    btnLink: '',
    workWithTechnology: [
      {
...
export const hireSwiftDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire Swift Developers',
    description: `Hire Swift developers from MindInventory, boasting a track record of 300+ successful projects for global clients since 2011. Our certified Swift developers for hire are adept at delivering app solutions for Apple platforms. Skip the hassle - hire Swift app developers with just a click!`,
    btnName: `schedule a call `,
    btnLink: '',
    workWithTechnology: [
      {
        title: '25+',
        description: 'Swift Developers',
      },
      {
        title: '90%',
        description: `Developer's Retention Rate`,
...
export const hireIconicDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire Ionic Developers',
    description: `Tap into our skilled technical talent pool to hire Ionic app developers well-versed to meet the full spectrum of your mobile app needs. Be it a startup, mid-level, or enterprise-level - our Ionic developers are experts at developing highly innovative, impactful cross-platform mobile app solutions.`,
    btnName: `schedule a call `,
    btnLink: '',
    workWithTechnology: [
      {
