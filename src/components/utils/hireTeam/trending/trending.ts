...
export const hireUnrealEngineDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire Unreal Engine Developers',
    description: `Looking to hire Unreal engine developers to bring your idea into a truly immersive experience? From AAA games to architectural visualization to simulations, our Unreal Engine developers for hire can use UE to deliver exemplary projects across industries.`,
    ...
    workWithTechnology: [
      ...
      {
        title: '100%',
        description: ' NDA-protected contract',
      },
      {
        title: '5+',
...
export const hireUIUXDesigner: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire UI UX Developers',
    description: `Hire UI/UX designers with exceptional creative edge and expertise in creating engaging user interfaces for digital solutions. Our UI/UX designers for hire are proficient in industry-standard design software and well-versed in UI/UX design best practices.`,
    btnName: `schedule a call `,
    btnLink: '',
    workWithTechnology: [
      {
...
export const hireSoftwareDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire Software Developers',
    description: `Hire software developers from MindInventory who are proficient in the latest technologies and excel in industry best practices. Whether you’re a startup or an established enterprise, our software developers are ready to tackle your unique challenges and deliver digital solutions that drive success.`,
    btnName: `schedule a call `,
    btnLink: '',
    workWithTechnology: [
      {
...
export const hireDevOpsDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire DevOps Developers',
    description: `Optimity Logics is your dedicated DevOps partner, ensuring seamless flow from project design to deployment. Hire DevOps developers from our team to ensure faster, more reliable, and efficient software releases and pave the way towards automation and seamless collaboration.`,
    btnName: `schedule a call `,
    btnLink: '',
    workWithTechnology: [
      {
...
export const hireMERNStackDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire MERN Stack Developers',
    description: `Hire MERN stack developers for your front-end and back-end development requirements to leverage their expertise in MongoDB, Express.js, React, and Node.js. Our team of dedicated MERN developers for hire specializes in harnessing the full potential of the MERN stack to develop a wide range of dynamic and scalable web applications.`,
    btnName: `schedule a call `,
    btnLink: '',
    workWithTechnology: [
      {
...
export const hireMEANStackDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire MEAN Stack Developers',
    description: `Optimity Logics has a skilled group of dedicated MEAN stack developers for hire, delivering comprehensive web development services to build robust Web Apps and Digital Solutions. Hire our MEAN programmers who bring years of experience from over 250+ delivered projects in front-end and back-end development, ensuring your project harnesses the full potential of MongoDB, Express.js, AngularJS, and Node.js for an exceptional web experience.`,
    btnName: `schedule a call `,
    btnLink: '',
    workWithTechnology: [
      {
        title: '15+',
        description: 'MEAN Stack Developers',
      },
      {
        title: '90%',
        description: `Developer's Retention Rate`,
...
export const hireGameDeveloper: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Hire Game Developers',
    description: `Hire expert game developers proficient in Unity and Unreal engines to build engaging games across various genres like Battle Royale, shooters, sandbox, and more. We have a team of passionate game developers for hire with hands-on experience in developing games for various gaming platforms, including PC, console, and mobile.`,
    btnName: `schedule a call `,
    btnLink: '',
    workWithTechnology: [
      {
