import backbone from '../../../../../public/webp/technology/front-end/backnone.webp';
...
export const BackboneJsData: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'BAckbone.js Web Development Company',
