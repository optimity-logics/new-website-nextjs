import weareableApp from '../../../../../public/webp/technology/trending/smart-watch.webp';
...
export const weareableAppData: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Wearable App Development Company',
    description: `Whether you are a fitness enthusiast, a healthcare provider, a business looking to enhance employee productivity or a wearable brand, MindInventory is your dedicated partner in wearable app development. From concept to deployment, our team of skilled developers deliver highly connected, real-time wearable app solutions tailored to your specific requirements and offer engaging user experiences. `,
    techImg: weareableApp,
    btnName: `share your product idea`,
    btnLink: '',
    workWithTechnology: [
      {
        title: '250+',
