import iot from '../../../../../public/webp/technology/trending/iot.webp';
...
export const internetOfThingsData: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Top IoT App Development Company',
    description: `Revolutionize your industry with smart connected devices or streamline your operations by harnessing the power of connected devices with IoT applications developed by MindInventory - a leading IoT app development company.`,
    techImg: iot,
    btnName: `consult now`,
    btnLink: '',
    workWithTechnology: [
