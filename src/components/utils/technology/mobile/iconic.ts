import iconic from '../../../../../public/webp/technology/mobile/iconic.webp';
...
export const Iconic: IPropsDataTypes = {
  HeroSectionData: {
    heading: 'Iconic App Development Company',
