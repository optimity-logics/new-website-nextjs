...
export const aws: IPropsDataTypes = {
  HeroSectionData: {
    heading: `<span class="text-red">AWS</span> App Development Company`,
    techName: 'aws',
...
export const googleCloud: IPropsDataTypes = {
  HeroSectionData: {
    heading: `<span class="text-red">GoogleCloud</span> App Development Company`,
...
export const azure: IPropsDataTypes = {
  HeroSectionData: {
    heading: `<span class="text-red">azure</span> App Development Company`,
    techName: 'azure',
    description: `Optimity Logics is a top-notch Flutter app development company in USA offering robust
cross-platform app development solutions. With a team of expert Flutter developers
onboard, we offer end-to-end Flutter app development services, from discovery to full-
