...
export const nextWave: IProjectDetail = {
  slug: 'nextwave',
  heroSection: {
...
fledged development solutions aligned with your business objectives.`,
    ...
    projectLogo: '/svg/client-logo-slider/black-icon/nextwave.svg',
    heroProjectMockupImg: '/webp/projectDetail/heroimg/pdnw.webp',
    heroBgimg: '/webp/projectDetail/bg/bgnw.webp',
  },
  aboutTheProject: {
    title: 'About The Project',
    description: `Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.`,
    projectMockupImages: '/webp/projectDetail/mockup-slide/nw.webp',
  },
  projectHomePageImage: '/webp/projectDetail/mockup/nw.webp',
  projectSubMockupImages: [
    '/webp/projectDetail/page-mockup/nw1.webp',
    '/webp/projectDetail/page-mockup/nw2.webp',
  ],
  projectSolution: {
    title: 'The Solution',
    description: `Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.`,
    ...
    projectLogo: '/svg/client-logo-slider/nextwave.svg',
    subDescription:
