...
export const satisFIND: IProjectDetail = {
  slug: 'satisfind',
  heroSection: {
...
fledged development solutions aligned with your business objectives.`,
    ...
    projectLogo: '/svg/client-logo-slider/black-icon/satisfind.svg',
    heroProjectMockupImg: '/webp/projectDetail/heroimg/pdsf.webp',
    heroBgimg: '/webp/projectDetail/bg/bgsf.webp',
  },
  aboutTheProject: {
    title: 'About The Project',
    description: `Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.`,
    projectMockupImages: '/webp/projectDetail/mockup-slide/sf.webp',
  },
  projectHomePageImage: '/webp/projectDetail/mockup/sf.webp',
  projectSubMockupImages: [
    '/webp/projectDetail/page-mockup/sf1.webp',
    '/webp/projectDetail/page-mockup/sf2.webp',
  ],
  projectSolution: {
    title: 'The Solution',
    description: `Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.`,
    ...
    projectUser: '/webp/projectDetail/pui/sf.webp',
  },
  exploreProjects: {
