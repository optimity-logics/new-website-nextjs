...
export const woodLogsScotland: IProjectDetail = {
  slug: 'woodlogsscotland',
  heroSection: {
...
fledged development solutions aligned with your business objectives.`,
    ...
    projectLogo: '/svg/client-logo-slider/black-icon/woodlogs.svg',
    heroProjectMockupImg: '/webp/projectDetail/heroimg/pdwls.webp',
    heroBgimg: '/webp/projectDetail/bg/bgwls.webp',
  },
  aboutTheProject: {
  ...
  projectHomePageImage: '/webp/projectDetail/mockup/mhts.png',
  ...
  projectSolution: {
    ...
    projectLogo: '/svg/client-logo-slider/woodlogs.svg',
    subDescription:
      'Powerful travel platforms engineered for your business success',
    projectUser: '/webp/projectDetail/pui/wls.webp',
  },
  exploreProjects: {
