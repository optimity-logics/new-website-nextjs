...
export const whiskersNPaws: IProjectDetail = {
  slug: 'whiskersnpaws',
  heroSection: {
...
fledged development solutions aligned with your business objectives.`,
    ...
    projectLogo: '/svg/client-logo-slider/black-icon/whiskerspaws.svg',
  ...
  aboutTheProject: {
    ...
    projectMockupImages: '/webp/projectDetail/mockup-slide/whiskersnpaw.webp',
  },
  ...
  projectSolution: {
    ...
    projectLogo: '/svg/client-logo-slider/whiskerspaws.svg',
    subDescription:
