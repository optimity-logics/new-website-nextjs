...
export const everPretty: IProjectDetail = {
  slug: 'everpretty',
  heroSection: {
...
fledged development solutions aligned with your business objectives.`,
    ...
    projectLogo: '/svg/client-logo-slider/black-icon/everpretty.svg',
    heroProjectMockupImg: '/webp/projectDetail/heroimg/pdep.webp',
    heroBgimg: '/webp/projectDetail/bg/bgep.webp',
  },
  aboutTheProject: {
    title: 'About The Project',
    description: `Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.`,
    projectMockupImages: '/webp/projectDetail/mockup-slide/ep.webp',
  },
  projectHomePageImage: '/webp/projectDetail/mockup/ep.webp',
  projectSubMockupImages: [
    '/webp/projectDetail/page-mockup/ep1.webp',
    '/webp/projectDetail/page-mockup/ep2.webp',
  ],
  projectSolution: {
    title: 'The Solution',
    description: `Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.`,
    ...
    projectLogo: '/svg/client-logo-slider/everpretty.svg',
    subDescription:
