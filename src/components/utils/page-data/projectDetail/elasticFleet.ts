...
export const elasticFleet: IProjectDetail = {
  slug: 'elasticfleet',
  heroSection: {
...
fledged development solutions aligned with your business objectives.`,
    ...
    projectLogo: '/svg/client-logo-slider/black-icon/elasticfleet.svg',
    heroProjectMockupImg: '/webp/projectDetail/heroimg/pdef.webp',
    heroBgimg: '/webp/projectDetail/bg/bgef.webp',
  },
  aboutTheProject: {
    title: 'About The Project',
    description: `Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.`,
    projectMockupImages: '/webp/projectDetail/mockup-slide/ef.webp',
  },
  projectHomePageImage: '/webp/projectDetail/mockup/ef.webp',
  projectSubMockupImages: [
    '/webp/projectDetail/page-mockup/ef1.webp',
    '/webp/projectDetail/page-mockup/ef2.webp',
  ],
  projectSolution: {
    title: 'The Solution',
    description: `Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.`,
    ...
    projectLogo: '/svg/client-logo-slider/elasticfleet.svg',
    subDescription:
