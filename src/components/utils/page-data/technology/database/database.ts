...
export const mysql: IPropsDataTypes = {
  HeroSectionData: {
...
export const postgresql: IPropsDataTypes = {
  HeroSectionData: {
...
export const mongodb: IPropsDataTypes = {
  HeroSectionData: {
...
export const redis: IPropsDataTypes = {
  HeroSectionData: {
...
export const firebase: IPropsDataTypes = {
  HeroSectionData: {
    heading: `<span class="text-red">Firebase</span> App Development Company`,
    techName: 'magento',
    description: `Optimity Logics is a top-notch Flutter app development company in USA offering robust
cross-platform app development solutions. With a team of expert Flutter developers
onboard, we offer end-to-end Flutter app development services, from discovery to full-
