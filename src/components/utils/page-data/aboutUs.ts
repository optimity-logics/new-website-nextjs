  ...
  expertise: [
    {
      ...
      bg: '/images/about-us/web-appbg.png',
      title: 'Web Apps',
      description:
    ...
    },
    {
      ...
      bg: '/images/about-us/digital-marketingbg.png',
    ...
    {
      img: '/webp/about-us/web-apps.webp',
      bg: '/images/about-us/web-app2.png',
      title: 'Web Apps',
      description:
        'cancellation make it easy to rethink your booking if your plans change.',
    },
  ...
  ourTeamList: [
    {
      ...
      aboutUs: `At Optimity Logics, leadership is driven by Hardik Paghdar, the CEO & Co-Founder with over 12+ years of hands-on experience in web development and technology consulting. He plays a key role in shaping the company’s vision, aligning technology with business objectives, and guiding long-term growth. Actively involved in solution architecture, client discussions, and delivery strategy, Hardik ensures practical and scalable outcomes. His focus on quality, transparency, and strong partnerships defines how Optimity Logics delivers value through technology.`,
    },
    {
      img: '/images/about-us/b1.png',
      name: 'Bhavin Dobariya',
      position: 'CTO & Co-Founder',
      aboutUs: `At Optimity Logics, the technical vision is led by Bhavin Dobariya, CTO & Co-Founder with more than a decade of experience in full-stack development and system architecture. He is responsible for defining technology standards, selecting scalable architectures, and ensuring performance and security across solutions. Bhavin works closely with engineering teams on design, code quality, and best practices. His passion for innovation and clean engineering drives the company’s ability to deliver reliable, future-ready products.`,
    },
    {
      img: '/images/about-us/d.png',
      name: 'Dixit Ramotiya',
      position: 'COO & Co-Founder',
      aboutUs: `At Optimity Logics, operations and execution are overseen by Dixit Ramotiya, COO & Co-Founder with over 10 years of experience in managing technical projects and delivery processes. He ensures smooth day-to-day operations, effective resource planning, and consistent delivery quality. With a strong technical foundation, Dixit bridges strategy and execution to keep teams aligned and projects on track. His result-oriented approach supports scalable growth and long-term client satisfaction.`,
    },
  ],
  benefitesTitle:
