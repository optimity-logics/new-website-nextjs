...
import linkedin from '../../../public/svg/footer/social-media/link.svg';
...
export const socialMediaIcons = [
  ...
  { link: 'https://www.linkedin.com/company/optimitylogics', icon: linkedin },
    ...
    megaMenuItem: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            techName: 'Svelte.js Developers',
            techLink: '/hire-svelte-js-developers',
          },
          {
            techName: 'JavaScript Developers',
