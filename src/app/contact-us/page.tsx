    ...
    <>
      <div className="bg-contactUsBanner bg-cover bg-center bg-no-repeat">
        <Container className="py-[122px]">
          <h2 className="font-opt text-4xl font-medium leading-[40px] tracking-[-0.16px] text-primary 3xl:text-[45px] 3xl:leading-[50px] 5xl:text-[57px] 5xl:leading-[60px]">
            Contact Us
          </h2>
        </Container>
      </div>
      <Container className="mb-10 mt-10 flex flex-col justify-between gap-7 md:mb-12 md:mt-12 md:gap-10 lg:mt-0 lg:flex-row lg:items-end xl:mb-16 4xl:mb-[100px] 4xl:px-[140px]">
        <div className="flex w-full max-w-[510px] flex-col gap-9">
          <h3 className="font-opt text-[26px] font-semibold leading-7 text-primary">
            Get in touch
          </h3>
          <div className="flex items-start gap-[18px]">
            <Image src={mail} alt="" width={34} height={34} />
            <div className="flex flex-col gap-2.5">
              <h5 className="font-opt text-xl font-medium leading-7 text-primary">
                React Us
              </h5>
              <span className="font-opt text-lg font-normal leading-6 text-primary">
          ...
          <div className="flex items-start gap-[18px]">
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <span className="max-w-[500px] font-opt text-lg font-normal leading-6 text-primary">
