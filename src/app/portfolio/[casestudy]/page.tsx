    ...
    <>
      <Container className="mb-10 pt-8 md:mb-12 xl:mb-16 xl:pt-10 3xl:pt-14 4xl:mb-[100px] 4xl:pt-20">
        <div className="flex flex-col items-center gap-7 lg:gap-10 xl:gap-12 3xl:gap-20">
          <h3 className="mx-auto max-w-[1044px] text-center font-Poppins text-xl font-medium text-[#192020] lg:text-2xl xl:text-3xl 3xl:text-4xl 5xl:text-[50px] 5xl:leading-[60px]">
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-3 xl:gap-8 3xl:gap-12 4xl:gap-[62px]">
            <div className="sticky top-[110px] col-span-1 hidden h-max flex-col gap-[18px] rounded-[25px] border border-[#000]/20 bg-white px-9 py-[29px] shadow-md md:flex">
              <div className="flex flex-col gap-1">
                <h4 className="font-Inter text-[22px] font-semibold leading-9 text-[#192020]">
                  lorem ipsum{' '}
                </h4>
                <Link
                  href={'/'}
                  className="font-Poppins text-xl font-light leading-9 text-[#192020]"
                >
                  lorem ipsum text
                </Link>
              </div>
            ...
            <div className="col-span-2 flex flex-col gap-8 xl:gap-10 3xl:gap-12 4xl:gap-20">
              <div className="flex flex-col gap-5 lg:gap-8 4xl:gap-[45px]">
                <div className="flex flex-col gap-[15px]">
                  <h3 className="font-Inter text-2xl font-medium leading-7 text-[#000] 4xl:text-[41px] 4xl:leading-[58px]">
                    The Brief
                  </h3>
                  <div className="flex flex-col gap-2">
                    <span className="font-Inter text-xl font-medium leading-6 text-[#000] xl:text-[22px] xl:leading-9">
                      Lorem Ipsum is simply dummy text of the printing and
                      typesetting industry.
                    </span>
                    <p className="font-Inter text-xl font-normal leading-6 text-[#504c4c] 4xl:text-[22px] 4xl:leading-8">
                      Lorem Ipsum is simply dummy text of the printing and
                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 4xl:gap-[50px] 4xl:gap-y-10">
                  {caseStudyData &&
                    caseStudyData.map((item, index) => (
                      ...
                      >
                        <h3 className="font-Poppins text-2xl font-medium leading-7 text-[#192020] 5xl:text-[30px] 5xl:leading-[39px]">
                          {item?.heading}
                        </h3>
                        <p className="font-Inter text-xl font-normal leading-6 text-[#504c4c] 5xl:text-2xl 5xl:leading-[34px]">
                          {item?.description}
                        </p>
                      </div>
                    ))}
